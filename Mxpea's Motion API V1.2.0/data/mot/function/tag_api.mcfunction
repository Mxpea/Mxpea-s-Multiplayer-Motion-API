...
#trace
execute as @e[tag=trace] at @s store result entity @s Motion[0] double 0.00002 run scoreboard players get @s x2
execute as @e[tag=trace] at @s store result entity @s Motion[1] double 0.00002 run scoreboard players get @s y2
execute as @e[tag=trace] at @s store result entity @s Motion[2] double 0.00002 run scoreboard players get @s z2
tag @e remove trace

#away
execute as @e[tag=away] at @s store result entity @s Motion[0] double -0.0001 run scoreboard players get @s x2
execute as @e[tag=away] at @s store result entity @s Motion[1] double -0.0001 run scoreboard players get @s y2
execute as @e[tag=away] at @s store result entity @s Motion[2] double -0.0001 run scoreboard players get @s z2
tag @e remove away
